      ...
      <main className="flex-grow container mx-auto px-4 py-12 mt-16">
        <Card className="max-w-md mx-auto bg-white shadow-lg">
          <CardContent className="p-8">
            ...
            <Button className="w-full bg-[#00B900] hover:bg-[#00A000] text-white py-6 font-bold rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:translate-y-[-2px] hover:shadow-lg flex items-center justify-center">
              <Image
